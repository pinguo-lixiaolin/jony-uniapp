	...
	<view class="content" @click="handleClose" :class="{ active: active }">
		...
		<view class="tabbar-box-wrap" :class="{ active: active }">
			<view class="tabbar-box">
				<view class="tabbar-box-item" @click.stop="goToPage('/pages/create/create?type=free')">
					<image class="box-image" src="../../../static/img/qa.png" mode="aspectFit" />
					<text class="explain">免费相册</text>
				</view>
				<view
					class="tabbar-box-item"
					@click.stop="goToPage('/pages/create/create?type=profesional')"
				>
				...
				<view
					class="tabbar-box-item"
					@click.stop="goToPage('/pages/create/create?type=article')"
				>
					<image
						class="box-image"
